...
SECRET_KEY = 'django-insecure-fd(+%duoy519pk)r&^v86#8i=4#hcdw7w(wdg%^8)i(=ws77+#'
...
# Les emails ne sont PAS envoyés, ils s'affichent juste dans le terminal

EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# Alternative pour production: décommenter et configurer
...
DEFAULT_FROM_EMAIL = 'gestion.stock@example.com'
